...
static void nlmsg_dump_viktor(struct nlmsghdr* njh)
{
        printk(KERN_INFO " %s:\n",__FUNCTION__);
        printk(KERN_INFO "      nlmsg_len = %d\n", njh->nlmsg_len);
        printk(KERN_INFO "      nlmsg_type = %d\n", njh->nlmsg_type);
        printk(KERN_INFO "      nlmsg_seq = %d\n", njh->nlmsg_seq);
        printk(KERN_INFO "      nlmsg_pid = %d\n", njh->nlmsg_pid);
        printk(KERN_INFO "      nlmsg_flags = %d\n", njh->nlmsg_flags);
}
